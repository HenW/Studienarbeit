...
https://www.gaisler.com/index.php/downloads/ runtergeladen werden kann.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{Hauptteil/xconfig.png}
...
Durch die vorherigen Schritte wurde eine „Allzweck-Konfiguration“ vorgenommen, welche im Detail in der Tablle ... beschrieben ist.\\
...
Die \ac{ahb}-Clock wird vom \ac{mmcm}-Modul in dem \ac{mig}-Controller generiert und kann mit Hilfe des Xilinx \ac{coregen} gesteuert werden.
...
Um dies zu beheben ist es nötig den Befehl
