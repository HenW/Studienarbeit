...
\begin{itemize}
\item make config: Qt basiert \ac{gui} (benötigt Qt-3/4 Bibliotheken)
\item make gconfig: \ac{gtk} basierte \ac{gui} GTK = GIMP Toolkit
...
Der Pfad, zu der im vorherigen Schritt installierten Toolchain, muss jetzt im Linuxbuild angegeben werden. Unter dem Menüpunkt \emph{Step 2:package configuration} und dem Unterpunkt \emph{Toolchain confirguration}
